...
// Convert each user's results into a simple array of numbers (ex: [5, 1, 4, 4, 5, 1, 2, 5, 4, 1]).
    ...
    // var scoresArr = newFriend.scores;
    // var scoresNum = scoresArr.split(",").map(function(scoresArr) {
    //     return parseInt(scoresArr, 10)
    // });

}

//compare the difference between user's scores against those from other users, question by question. Add up the differences to calculate the totalDifference.
// Example:
